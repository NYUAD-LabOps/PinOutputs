...
#define I2CMSGLENGTH 10
#define MAXERROR 1.0 /// %
#define MINPRECISION 1.0 /// %
///Default target speed for the tool head, in mm/min.
/// This is used if a movement command is received, but no target speed
/// has yet been given.
#define DEFAULTSPEED 3000
#define ACCEL 1
...
} *motorBlockX, *motorBlockY, *motorBlockZ;
